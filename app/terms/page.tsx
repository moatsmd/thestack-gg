  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 pt-6 md:pt-12">
      <header className="text-center mb-8">
        ...
        <p className="font-display tracking-[0.16em] uppercase text-xs text-muted-foreground mt-3">House Rules</p>
      ...
      <article className="panel codex-glow p-6 md:p-10 font-prose text-base leading-relaxed text-foreground/90 space-y-4">
        ...
        <h3 className="font-display tracking-wide text-lg text-foreground mt-6">Use</h3>
        ...
        <h3 className="font-display tracking-wide text-lg text-foreground mt-6">Intellectual Property</h3>
        ...
        <h3 className="font-display tracking-wide text-lg text-foreground mt-6">Liability</h3>
        <p>The site is offered without warranty. We are not responsible for misplays, missed triggers, or misread cards.</p>

        <h3 className="font-display tracking-wide text-lg text-foreground mt-6">Changes</h3>
