...
const ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/new-players/cast', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/new-players/turn', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/new-players/combat', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/new-players/stack', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/new-players/table', priority: 0.6, changeFrequency: 'monthly' },
