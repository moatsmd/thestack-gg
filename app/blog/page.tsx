  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-8 pt-6 md:pt-12 pb-24">
      <header className="text-center mb-10">
        ...
        <p className="font-prose text-base md:text-lg text-foreground/80 mt-4 max-w-2xl mx-auto">
        ...
        {posts.map((post) => (
          <li key={post.slug}>
            ...
            >
              ...
              <p className="font-prose text-base text-foreground/80 mt-3 leading-relaxed">
                {post.excerpt}
              </p>
              <div className="flex items-center gap-3 mt-5 font-display tracking-[0.12em] uppercase text-[10px] text-muted-foreground">
