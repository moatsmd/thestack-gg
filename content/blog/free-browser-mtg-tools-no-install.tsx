...
const post: BlogPost = {
  ...
  description:
    'A working list of free, browser-based Magic tools that need no install \u2014 life trackers, card lookup, dice, glossary, stack visualizer, token reference and tray. What each is good for.',
  date: '2026-05-08',
  category: 'Tools',
  readingTime: 8,
  excerpt:
  ...
  body: (
    <>
      <Lede>
        ...
        can remember your game between visits. This is a working list of the
      ...
      <P>
        ...
        an animated explainer of a Red-Elemental-Blast-on-Counterspell-on-Lightning-
      ...
      <P>
        ...
        questions like &ldquo;does deathtouch work with trample?&rdquo; One
        damage from a source with deathtouch counts as lethal when assigning
        combat damage. Ward is different: targeting a permanent with ward
        triggers an ability that counters the opposing spell or ability unless
        its controller pays. Indestructible does not stop that countering.
      </P>
      <UL>
      ...
      <H2>Token references and trays</H2>
      <P>
        Covered in the <A href="/blog/mtg-token-generator-every-set">token guide</A>.
        Browse common token variants and track their quantities on this browser.
        Check the source card for exact characteristics, and keep tapped
        creatures and counters separate on your playmat.
      </P>

      <H2>Dice and randomizers</H2>
      <P>
        Cards such as Delina, Wild Mage ask for a d20 roll. A browser roller
        keeps the result visible to the table. Coin flips, physical dexterity
        cards, and hidden-choice games need their own procedures.
      </P>
      <P>
      ...
      <OL>
        ...
        <LI><Em>Clear offline limits.</Em> An already-loaded local tracker can keep counts; shared-table syncing and fresh card or rules lookups need a connection.</LI>
      ...
      <P>
        ...
        <A href="/glossary">glossary</A>, <A href="/tokens">token reference and tray</A>,{' '}
